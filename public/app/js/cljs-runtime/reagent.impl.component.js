...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11503 = c;
var G__11503__$1 = (((G__11503 == null))?null:G__11503.prototype);
if((G__11503__$1 == null)){
return null;
} else {
return G__11503__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11504 = c;
var G__11504__$1 = (((G__11504 == null))?null:G__11504.prototype);
if((G__11504__$1 == null)){
return null;
} else {
return G__11504__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__11506 = c;
var G__11506__$1 = (((G__11506 == null))?null:G__11506.constructor);
if((G__11506__$1 == null)){
return null;
} else {
return G__11506__$1.displayName;
}
})();
...
var G__11507 = c;
var G__11507__$1 = (((G__11507 == null))?null:G__11507.constructor);
if((G__11507__$1 == null)){
return null;
} else {
return G__11507__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11508 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11509 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11509);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11508);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__11510 = key;
var G__11510__$1 = (((G__11510 instanceof cljs.core.Keyword))?G__11510.fqn:null);
switch (G__11510__$1) {
...
var c = this;
var G__11512_11532 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11512_11532 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11512_11532);
}
...
var renders_11533 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11534 = cljs.core.first(cljs.core.vals(renders_11533));
...
if((cljs.core.count(renders_11533) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11533))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11534)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11534], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11513 = o;
reagent.impl.component.goog$module$goog$object.set(G__11513,cljs.core.name(k),v);
...
while (G__11537__i < G__11537__a.length) {G__11537__a[G__11537__i] = arguments[G__11537__i + 0]; ++G__11537__i;}
  args = new cljs.core.IndexedSeq(G__11537__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__11514 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11515 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11515);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11514);
}});
...
var vec__11516 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11516,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11516,(1),null);
...
var G__11519 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11519 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11519);
}
});
}),[]);
