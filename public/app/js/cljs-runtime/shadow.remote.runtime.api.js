...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13220 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13220(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13223 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13223(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13226 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13226(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13230 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13230(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13243 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13243(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13248 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13248(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13215,callback){
var map__13216 = p__13215;
var map__13216__$1 = cljs.core.__destructure_map(map__13216);
var input = map__13216__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13216__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13216__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
