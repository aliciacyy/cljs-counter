...
var i_14167 = (0);
while(true){
if((i_14167 < arr.length)){
(arr[i_14167] = null);

var G__14168 = (i_14167 + (1));
i_14167 = G__14168;
continue;
} else {
}
...
var i_14200 = (self__.level + (1));
while(true){
if((i_14200 <= (new_level + (1)))){
(update[i_14200] = self__.header);

var G__14202 = (i_14200 + (1));
i_14200 = G__14202;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14203 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14203[i]));
} else {
x__$2.forward.push((((i < links_14203.length))?(links_14203[i]):null));
}

if((i < links_14203.length)){
(links_14203[i] = x__$2);
} else {
links_14203.push(x__$2);
}
...
var i_14213 = (0);
while(true){
if((i_14213 <= self__.level)){
var links_14214 = (update[i_14213]).forward;
if((x__$1 === (((i_14213 < links_14214.length))?(links_14214[i_14213]):null))){
(links_14214[i_14213] = (x__$1.forward[i_14213]));

var G__14218 = (i_14213 + (1));
i_14213 = G__14218;
continue;
} else {
var G__14219 = (i_14213 + (1));
i_14213 = G__14219;
continue;
}
} else {
